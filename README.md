...
> **My Bachelor's Thesis Project (@ MTUCI)**. A 2D simulation of a GPS-less navigation system for agricultural machinery, utilizing an Extended Kalman Filter (EKF), UWB-beacon mesh network, and boustrophedon path planning.
